...
add_action( 'after_setup_theme', 'ume_setup' );
 ...
 */
function ume_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'ume_content_width', 640 );
}
add_action( 'after_setup_theme', 'ume_content_width', 0 );
...
add_action( 'widgets_init', 'ume_widgets_init' );

/**
 * Filter the stylesheet_uri to output the minified CSS file.
 */
function ume_minified_css( $stylesheet_uri, $stylesheet_dir_uri ) {
...
add_filter( 'stylesheet_uri', 'ume_minified_css', 10, 2 );
